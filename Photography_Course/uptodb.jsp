	...
	String a="";
	   ...
	   if ((contentType.indexOf("multipart/form-data") >= 0)) {
	      ...
	      try{ 
	         ...
	         while ( i.hasNext () ) 
	         {
	            ...
	            a=fileName;
	                ...
	                out.print(fi.getString("UTF-8")+"   "+formvalue_num+"   ");
	            }	
	         }fileItems.clear();
	         out.println("</body>");
	         out.println("</html>");
		...
		String url = "jdbc:mysql:"
				+ "//127.0.0.1:3306/watermelon?useSSL=false&useUnicode=true&characterEncoding=utf8&serverTimezone=GMT"; //bin_db为你的数据库的名称   
		...
		try {
			...
			if (formvalue[1].equals("1")) {
				String sql_insert = "insert into activity_detail_about values(" + "'" + formvalue[0] + "'" + "," + "'"
